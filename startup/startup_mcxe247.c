...
WEAK void CAN2_ORed_IRQHandler(void);
...
void CAN0_ORed_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN0_Error_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN0_Wake_Up_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN0_ORed_0_15_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN0_ORed_16_31_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void CAN1_ORed_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void CAN1_ORed_0_15_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN1_ORed_16_31_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void CAN2_ORed_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void CAN2_ORed_0_15_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void CAN2_ORed_16_31_MB_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    I2S1_Tx_IRQHandler,              // 71 : Transmit Synchronous interupt (for interrupt controller)
    I2S1_Rx_IRQHandler,              // 72 : Transmit Synchronous interupt (for interrupt controller)
    ...
    I2S0_Tx_IRQHandler,              // 86 : Transmit Synchronous interupt (for interrupt controller)
    I2S0_Rx_IRQHandler,              // 87 : Transmit Synchronous interupt (for interrupt controller)
    ...
    CAN0_ORed_IRQHandler,            // 94 : CAN0 OR'ed interrupt
    ...
    CAN1_ORed_IRQHandler,            // 101: CAN1 OR'ed interrupt
    ...
    CAN2_ORed_IRQHandler,            // 108: CAN2 OR'ed interrupt
